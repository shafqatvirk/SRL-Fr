...
param probabilities5[Assignment["Risky_situation"]] := read "../frameData/frame5.txt" as "<1s,2s> 3n" skip 2;
 ...
 #Objective Function 
maximize assign : (sum <r,s> in Assignment["Quantity"] : probabilities0[r,s] * z0[r,s])+(sum <r,s> in Assignment["Intentionally_act"] : probabilities1[r,s] * z1[r,s])+(sum <r,s> in Assignment["Means"] : probabilities2[r,s] * z2[r,s])+(sum <r,s> in Assignment["Adopt_selection"] : probabilities3[r,s] * z3[r,s])+(sum <r,s> in Assignment["Hostile_encounter"] : probabilities4[r,s] * z4[r,s])+(sum <r,s> in Assignment["Risky_situation"] : probabilities5[r,s] * z5[r,s]);
#Constraints
#Overlap Constraints
set I := {0 to 12};
set G[I] := <0> {"0_0","0_12","0_5"}, <1> {"0_12","0_5","1_1"}, <2> {"0_12","0_5","2_2"}, <3> {"0_12","0_5","3_3"}, <4> {"0_12","0_5","4_4"}, <5> {"0_12","0_5","5_5"}, <6> {"0_12","6_12","6_6"}, <7> {"0_12","6_12","7_11","7_7"}, <8> {"0_12","6_12","7_11","8_11","8_8"}, <9> {"0_12","6_12","7_11","8_11","9_9"}, <10> {"0_12","10_10","10_11","6_12","7_11","8_11"}, <11> {"0_12","10_11","11_11","6_12","7_11","8_11"}, <12> {"0_12","12_12","6_12"};
